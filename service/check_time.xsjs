...
var query = "SELECT * FROM (SELECT * FROM \"IMEI.BOOKINGS\" WHERE TO_VARCHAR(KENNZEICHEN) = '" + kennzeichen + "') "
+ " WHERE ('" + startZeit + "' <= \"START\" AND '" + endeZeit + "' >= \"START\")"
+ " OR ('" + startZeit + "' >= \"START\" AND '" + endeZeit + "' <= \"ENDE\")"
+ " OR ('" + startZeit + "' <= \"ENDE\" AND '" + endeZeit + "' >= \"ENDE\")"
+ " OR ('" + startZeit + "' <= \"START\" AND '" + endeZeit + "' >= \"ENDE\");";
/*var query = "SELECT * FROM (SELECT * FROM \"A582909\".\"IMEI.BOOKINGS\" WHERE TO_VARCHAR(KENNZEICHEN) = '" + kennzeichen + "') "
+ " WHERE ('" + startZeit + "' <= \"START\" AND '" + endeZeit + "' >= \"START\")"
+ " OR ('" + startZeit + "' >= \"START\" AND '" + endeZeit + "' <= \"ENDE\")"
+ " OR ('" + startZeit + "' <= \"ENDE\" AND '" + endeZeit + "' >= \"ENDE\")"
+ " OR ('" + startZeit + "' <= \"START\" AND '" + endeZeit + "' >= \"ENDE\");";*/
