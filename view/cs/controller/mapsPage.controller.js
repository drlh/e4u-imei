sap.ui.controller("ccs.mapsPage", {
...
/*initMap : function() {
  ...
  var map = new google.maps.Map(this.getView().byId("map_test"), {
    zoom: 7,
    center: {lat: 51.516, lng: 9.916}
  });
  ...
  this.getView().byId('FromDis').addEventListener('change', onChangeHandler);
  this.getView().byId('ToDis').addEventListener('change', onChangeHandler);
},
calculateAndDisplayRoute : function(directionsService, directionsDisplay) {
  directionsService.route({
    origin: this.getView().byId('start').value,
    destination: this.getView().byId('end').value,
...
window.mapOptions = {                          
center: new google.maps.LatLng(51.516, 9.916),
zoom: 6,
